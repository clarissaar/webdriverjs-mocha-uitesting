...
exports.changeLeadStatuses = function (driver, oldStatus, newStatus) {
    ...
    driver.wait(until.elementLocated(By.xpath("//li[@class='leads']//a[@href='/settings/leads']")), 50000);
    ...
    driver.wait(until.elementLocated(By.xpath("//*[@class='control-group item']//*[contains(text(),'" + oldStatus + "')]/../..//button")), 50000);
