...
exports.createLead = function (driver, firstName, lastName, company, status) {
    driver.wait(until.elementsLocated(By.id('nav-leads')), 50000);
    driver.findElement(By.id('nav-leads')).click();
    driver.wait(until.elementLocated(By.id('leads-new')), 50000);
    ...
    driver.wait(until.elementsLocated(By.css('.detail-title')), 50000);
...
exports.verifyLeadStatus = function (driver, firstName, lastName, status) {
    driver.wait(until.elementsLocated(By.id('nav-leads')), 50000);
    driver.findElement(By.id('nav-leads')).click();
    driver.wait(until.elementLocated(By.xpath("//*[@class='object-list-items leads']//*[contains(., '" + firstName + " " + lastName + "')]//*[@class='lead-name']")), 80000);
...
exports.deleteLead = function (driver, firstName, lastName) {
    ...
    driver.wait(until.elementLocated(By.xpath("//*[@class='object-list-items leads']//*[contains(., '" + firstName + " " + lastName + "')]//*[@class='lead-name']")), 80000);
    driver.findElement(By.xpath("//*[@class='object-list-items leads']//*[contains(., '" + firstName + " " + lastName + "')]//*[@class='lead-name']")).click();
    driver.wait(until.elementLocated(By.xpath("//*[@class='detail-title']//*[contains(., 'Edit')]//*[@class='btn btn-mini detail-edit']")), 80000);
    driver.findElement(By.xpath("//*[@class='detail-title']//*[contains(., 'Edit')]//*[@class='btn btn-mini detail-edit']")).click();
    driver.wait(until.elementLocated(By.css('.remove')), 80000);
    driver.findElement(By.css('.remove')).click();
    driver.wait(until.elementLocated(By.xpath("//*[@class='btn btn-primary btn-danger  confirm']")), 80000);
    driver.findElement(By.xpath("//*[@class='btn btn-primary btn-danger  confirm']")).click();
}
